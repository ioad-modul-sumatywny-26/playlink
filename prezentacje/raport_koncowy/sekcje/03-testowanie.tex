...
PlayLink jest pokryty obszernym, zautomatyzowanym zestawem testów: około
\textbf{133 testy} po stronie backendu (pytest) oraz około \textbf{60 testów} po
...
\emph{rsvp-update}, \emph{roster-update}, \emph{room-closed}, \emph{kick}.

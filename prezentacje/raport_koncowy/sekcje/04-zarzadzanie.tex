...
niefunkcjonalne; aplikacja działa na środowisku produkcyjnym. Świadomie pominięto
komponent AI/ML (uzgodnione z opiekunem — zob.\ rozdz.~\ref{sec:aiml}), przekierowując
wysiłek na bezpieczeństwo danych.

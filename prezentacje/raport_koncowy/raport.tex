...
Uwzględnienie wybranych aspektów AI/ML\,$^{\dagger}$ & \na \\
Uwzględnienie co najmniej 90\% aspektów AI/ML\,$^{\dagger}$ & \na \\
...
\noindent\footnotesize $^{\dagger}$ Aspekty AI/ML zostały — w uzgodnieniu z opiekunem projektu
(mgr inż. Bartłomiej Jencz) — świadomie zastąpione rozszerzonym naciskiem na
bezpieczeństwo danych (tożsamość bezhasłowa BIP39, podpisy ECDSA/EIP-191,
ochrona przed atakami powtórzeniowymi). Uzasadnienie w rozdziale~\ref{sec:bezp}.
\normalsize
\newpage

% =====================================================================
\input{sekcje/01-analiza}
\input{sekcje/02-implementacja}
\input{sekcje/03-testowanie}
\input{sekcje/04-zarzadzanie}
